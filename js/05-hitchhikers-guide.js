...
// Or Var-2-Zak`s
/*let choice = prompt('Are you ready to play the game? (y/n)')
...
if (choice === 'y') {
    ...
    let rating = prompt('The game is over. Please rate the game between 1 and 10')

    if (rating < 1 || rating > 10) {
        alert('Thank you for playing the game')
    } else {
        if (rating >= 6) {
            alert('Thank you for playing the game. Please play again.')
        } else {
            alert('Thank you for playing the game. We\'re working hard to improve.')
        }
    } 
} else {
